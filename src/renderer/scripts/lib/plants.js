...
const Plants = {
  ...
  LEGACY_MAP: { grass: 'fern', clover: 'pothos', cherry: 'lavender', sunflower: 'monstera', bamboo: 'monstera', cactus: 'monstera', lotus: 'lavender', sapling: 'pothos', maple: 'monstera', rose: 'lavender' },
